...
<strong>Registration Type: </strong>Education/Faculty<br />
...
<strong>Hotel Accommodations: </strong>{hotel}
</p>
<!-- BEGIN Display -->
<p>
<strong>NOTE: Due to Keenland running during the dates of April 10-11 hotel room availability is limited and will fe first come first serve as part of the conference fees.</strong>
</p>
<p>
<strong>Request scholarship to cover hotel costs: </strong>{schol_cost}<br />
<strong>Room Type: </strong>{room}<br />
<strong>Roomate Preference: </strong>{roomate}<br />
<!-- END Display --> 
